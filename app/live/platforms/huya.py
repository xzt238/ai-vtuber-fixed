...
@LivePlatformFactory.register(PlatformType.HUYA)
        ...
        try:
            ...
            async with aiohttp.ClientSession() as session:
                async with session.get(
                    f"{self._api_base}/cache.php?m=Live&do=ajaxRoom&room={room_id}",
                    headers=headers
                ) as response:
